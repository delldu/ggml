...
void help(char* cmd)
{
    ...
    printf("Control:\n");
    printf("    --control_model <filename>  Contreol model(default: %s)\n", sdxl_turbo_config.control_model_path);
...
int main(int argc, char** argv)
{
    ...
    struct option long_opts[] = { { "help", 0, 0, 'h' },
        // Input ...
        { "device", 1, 0, 'd' }, { "model", 1, 0, 'm' }, { "image", 1, 0, 'i' }, { "positive", 1, 0, 'p' },
        { "negative", 1, 0, 'n' }, { "noise", 1, 0, 'N' }, { "steps", 1, 0, 's' }, { "seed", 1, 0, 'S' },

        // Control ...
        { "control_model", 1, 0, '0' }, { "control_image", 1, 0, '1' }, { "control_strength", 1, 0, '2' },

        // Output ...
        { "height", 1, 0, 'H' }, { "width", 1, 0, 'W' }, { "output", 1, 0, 'O' }, { "verbose", 0, 0, 'V' },
        { 0, 0, 0, 0 } };
